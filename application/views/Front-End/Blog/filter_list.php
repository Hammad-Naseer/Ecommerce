                        ...
                        <?php foreach($list as $row1){  ?>
                            ...
                            <div class="product-item">
							 ...
							 <img src="<?php echo base_url('uploads/'.$row1->image); ?>" alt="product-pic" width="100%" height="400%" class="img-fluid" />
                                    ...
                                    <ul>
                                     <li class="w-icon active quick-view"><a href="<?php echo base_url(); ?>add_to_cart/<?= $row1->product_id ?>">+ Add to cart </a></li>
                                    </ul>
                                </div>
                                <div class="pi-text">
                                    <div class="catagory-name"></div>
                                    <a href="<?php echo base_url() ?>CustomerController/category_products_listing/<?= $row1->product_id ?>">
