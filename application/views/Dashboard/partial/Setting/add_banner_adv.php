  ...
  <!-- ============================================================== -->
            ...
            <div class="content-page">
                <div class="content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Add/Adv Banner </h4>
                    ...
                    <form action="<?php echo  base_url();?>SettingController/insert_data_adv" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="title" name="title" id="title" class="form-control" value="<?php echo set_value('title')?>" placeholder="Add  Company Email">
