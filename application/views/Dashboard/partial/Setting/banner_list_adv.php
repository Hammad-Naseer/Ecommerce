                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <?php if($error =$this->session->flashdata('Banner')): ?>
                                                    <div class="row">
                                                    <div class="col-lg-6">
                                ...
                                <div class="card">
                                            <div class="col-auto py-2" style="padding-left: 20px;">
                                                <div class="text-lg my-1 my-lg-0">
                                                    ...
                                                    <a href="add_adv_banner" class="btn btn-danger waves-effect waves-light"><i class="mdi mdi-plus-circle me-1"></i> Add Advertisement Data</a>
                                                </div>
                                            </div>
                                    <div class="card-body">
                                        <h4 class="header-title">View List</h4>
                                            ...
                                            <?php
                                             ...
                                             foreach($temp as $row){  
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?=  anchor("SettingController/edit_banner_adv/{$row->id}",'Edit',['class'=>'btn btn-primary']);?></td>
                                                    <td><?= anchor("SettingController/delete_banner_adv/{$row->id}",'Delete',['class'=>'btn btn-danger']);?></td>
                                                </tr>
