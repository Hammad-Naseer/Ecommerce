  ...
  <!-- ============================================================== -->
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <form action="<?php echo  base_url();?>SettingController/insert_setting_data" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                    <div class="mb-3">
                                            ...
                                            <input type="email" name="email" id="email" class="form-control" value="<?php echo set_value('email')?>" placeholder="Add  Company Email">
                                            <?php echo form_error('email',"<div class='error' style='color:red;'>","</div>"); ?>  
                                        </div>
                                        <div class="mb-3">
                                            <label for="product-name" class="form-label">Company Contact<span class="text-danger">*</span></label>
                                            <input type="phone_number" name="phone_number" id="email" class="form-control" value="<?php echo set_value('phone_number')?>" placeholder="Add  Company Email">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="facebook_link" id="name" class="form-control" value="<?php echo set_value('facebook_link')?>" placeholder="Add  Facebook Link">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="twiter_link" id="twiter_link" class="form-control" value="<?php echo set_value('twiter_link')?>" placeholder="Add  Twiter Link">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="indeed" id="twiter_link" class="form-control" value="<?php echo set_value('indeed')?>" placeholder="Add  indeed Link">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="pinterest" id="twiter_link" class="form-control" value="<?php echo set_value('pinterest')?>" placeholder="Add  pinterest Link">
