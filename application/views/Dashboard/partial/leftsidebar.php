...
<div class="h-100" data-simplebar>
    ...
    <div id="sidebar-menu">
        ...
        <ul id="side-menu">
            ...
            <li class="menu-title">Sidebar-Navigation</li>

            <li>
           
                <a href="<?= base_url() ?>admin" data-bs-toggle="">
            ...
            <li>
                ...
                <div  id="sidebarEcommerce">
                    <ul class="nav-second-level">
                        ...
                        <li>
                            <a href="<?=base_url()?>view">View Category</a>
                        </li>
                        <li>
                            <a href="<?=base_url()?>add_brand">Add Brand</a>
                        </li>
                        <li>
                            <a href="<?php echo  base_url(); ?>index.php/brand_view">View Brand</a>
                        </li>
                        ...
                        <li>
                            <a href="<?=base_url()?>view_product">Products</a>
                        </li>
                        <li>
                            <a href="<?=base_url()?>Add_inventory">Add Inventory</a>
                        </li>
                        <li>
                            <a href="<?=base_url()?>view_inventory">View Inventory</a>
                        </li>
                        <li>
                            <a href="<?=base_url()?>add_blog">Add Blog</a>
                        </li>
                        <li>
                            <a href="<?=base_url()?>list_blog">List Blog</a>
                        </li>
                        <li>
                            <a href="<?= base_url() ?>add_adv">Add Slider Data</a>
                        </li> 
                        <li>
                            <a href="<?= base_url() ?>view_adv"> Slider Detail</a>
                        </li> 
                        
                        <li>
                            <a href="<?=base_url()?>view_customer">Customers</a>
                        </li>
                        <li>
                            <a href="<?=base_url()?>view_order">Orders</a>
                        </li>
                      
                        <li>
                            <a href="<?=base_url()?>add_data">Add Data Setting</a>
                        </li>

                        <li>
                            <a href="<?=base_url()?>view_data">View Setting</a>
                        </li>
                        <li>
                            <a href="<?=base_url()?>view_notificationList">Notification View</a>
                        </li>
                        <li>
                            <a href="<?=base_url()?>view_viewList">View Review</a>
                        </li>
                        <li>
                            <a href="<?=base_url()?>add_adv_banner">Add BannerAdv</a>
                        </li>
                        <li>
                            <a href="<?=base_url()?>view_banner_data_adv">View BannerAdv</a>
                        </li>
                        <li>
                            <a href="<?=base_url()?>admin_chat">AD_Chat </a>
                        </li>
                    </ul>
                </div>
            </li>
