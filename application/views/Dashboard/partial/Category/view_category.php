                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                    <a href="<?php echo base_url() ?>add_category" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-1"></i> Add Category</a>
                                            ...
                                            <?php
                                             ...
                                             foreach($temp as $row){  
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?=  anchor("CategoryController/edit_category/{$row->id}",'Edit',['class'=>'btn btn-primary']);?></td>
                                                    <td><?= anchor("CategoryController/delete_category/{$row->id}",'Delete',['class'=>'btn btn-danger']);?></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
