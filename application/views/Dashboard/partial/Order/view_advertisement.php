                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Slider Data List</h4>
                                ...
                                <div class="card">
                                            <div class="col-auto py-2" style="padding-left:20px ;">
                                                <div class="text-lg my-1 my-lg-0">
                                                    ...
                                                    <a href="add_adv" class="btn btn-danger waves-effect waves-light"><i class="mdi mdi-plus-circle me-1"></i> Add Slider Data</a>
                                                </div>
                                            </div>
                                    <div class="card-body">
                                            ...
                                            <?php
                                             ...
                                             foreach($temp as $row){  
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?=  anchor("OrderController/edit_adv/{$row->id}",'Edit',['class'=>'btn btn-primary']);?></td>
                                                    <td><?= anchor("OrderController/delete_adv/{$row->id}",'Delete',['class'=>'btn btn-danger']);?></td>
                                                </tr>
